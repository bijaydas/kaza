<x-layouts.page breadcrumbs="adminUsers">
    ...
    <x-slot:description>Edit your users here</x-slot:description>

    @can('update_user')
        <form wire:submit="save" class="w-1/2 flex flex-col gap-y-4">
                ...
                <div class="flex">
                    <div class="flex-1">
                        ...
                        <div class="flex">
                            ...
                            <x-form.radio wire:model="form.gender" name="gender" value="0" label="Not selected" />
                        </div>
                    </div>
                    <div class="flex-1">
